      ...
      <footer className="bg-white border-t border-gray-100 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            <a href="/" className="text-xl font-light tracking-[0.4em] uppercase text-black mb-6 block">
              BeStylish
            </a>
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs text-gray-500 font-medium tracking-widest">
              ...
              <li><a href="#" className="hover:text-black transition-colors">BESPOKE SUITS</a></li>
              <li><a href="#" className="hover:text-black transition-colors">TRADITIONAL WEAR</a></li>
              <li><a href="#" className="hover:text-black transition-colors">STREETWEAR</a></li>
            </ul>
          </div>
